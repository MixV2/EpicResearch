...
A client credentials session can be used to perform non-user actions such as obtaining cloudstorage, checking for updates, retrieving the catalog, and many more.
